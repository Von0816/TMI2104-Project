    ...
    <body id="body">
        ...
        <section class="CarInfo">
            <div class="row">
                <div class="col-1">
                    <h2>Nissan Navara</h2>
                    <h3>Nissan Navara Diesel King Cab Pick Up Acenta 2.3dCi 163 TT 4WD</h3>
                    <h3>(Brand New)</h3>
                    <p>Fuel : Diesel </p>
                    <p>Paint : Non Metalic</p>
                    <p>Gearbox : Manual</p>
                    <h4>£361.12/mth including VAT</h4>
                    
                    <form action="booking.php" name="carForm" method="post">
                        <input type="hidden" id ="carType" name="carType" vaLue="8"/>
                        <a><button type="submit" name = "submit">Book Now </button>
                    </form>

                </div>
                <div class="col-2">
                    <img src="img\Nissan Navara.jpg" class ="car">
