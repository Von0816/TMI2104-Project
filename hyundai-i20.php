    ...
    <body id="body">
        ...
        <section class="CarInfo">
            <div class="row">
                <div class="col-1">
                    <h2>Hyundai i20</h2>
                    <h3>1.0 T GDi MHD SE Connect 48v (100bhp) Hatchback 5dr Petrol Manual (100bhp)</h3>
                    <h3>(Brand New)</h3>
                    <p>Fuel : Petrol </p>
                    <p>Paint : Metalic</p>
                    <p>Gearbox : Manual</p>
                    <h4>£208.74/mth including VAT</h4>
                   
                    <form action="booking.php" name="carForm" method="post">
                        <input type="hidden" id ="carType" name="carType" vaLue="6"/>
                        <a><button type="submit" name = "submit">Book Now </button>
                    </form>

                </div>
                <div class="col-2">
                    <img src="img\Hyundai i20.jpg" class ="car">
