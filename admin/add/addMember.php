<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "INSERT INTO member(memberID, memberUsername, memberName, memberAddress, memberEmail, memberHP, memberPassword) VALUES('$memberID', '$memberUsername', '$memberName', '$memberAddress', '$memberEmail', '$memberHP', '$memberPassword')";
