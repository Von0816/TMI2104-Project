...
<body>
  ...
  <section>
    ...
    <form method="post" action="member_registeration_conn.php" name="myForm" onsubmit="jsValidate()">
      <fieldset>
      ...
      <div class="center">
        <input type="submit" onlick="register()" name="btnSubmit" value="Register">
  ...
  <footer class="f">
            ...
            <p><center> Company Reg No: 6178634 || VAT No: 866 0241 30 <br>
                @ Copyright 2004 - 2022 LINGsCARS.com. All rights reserved.<center><br><br></p>
        </footer>
    </section>
